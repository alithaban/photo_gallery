...
/* 			$this->parsed_response = $this->clean_text_nodes(json_decode($this->response, TRUE)); */
		...
		*/
		...
		function photos_getRecent ($extras = NULL, $per_page = NULL, $page = NULL) {
			...
			return $this->call('flickr.photos.getRecent', array('api_key' => $this->api_key, 'extras' => $extras, 'per_page' => $per_page, 'page' => $page));
		}
		...
		function photos_search ($args = array()) {
			...
			return ($this->parsed_response) ? $this->getURLS($this->parsed_response['photos']) : false;
		}
